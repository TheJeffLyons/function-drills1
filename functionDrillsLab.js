...
//const string1 = "I am a JavaScript ninja!";
...
*/
let candy = `i love food`

const exclaimThree = () => {return candy}
console.log(candy)
...
*/
let sampleStringUpper = sampleString.toUpperCase();

function getString(){
    console.log(sampleStringUpper)
...
function emailCheck(email){
 ...
 let stringEmail2 = stringEmail.replace(/\s+/g, '')
 console.log(stringEmail2)
  if(stringEmail2.includes(`@`)){
